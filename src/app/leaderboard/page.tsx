      ...
      <section className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="smooth-card overflow-hidden">
          <div className="bg-nusantara-navy p-8 text-white">
            ...
            <p className="mt-3 text-white/70">Peringkat sementara berdasarkan XP, level, dan penyelesaian misi.</p>
          </div>
          <div className="p-6">
            <div className="space-y-3">
              {leaderboard.map((item) => (
                <div key={item.rank} className="flex items-center justify-between rounded-3xl bg-slate-50 p-4">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-bold text-nusantara-navy">{item.name}</p>
